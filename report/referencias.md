...
- `arch`: documentacao do pacote Python para modelos de volatilidade condicional.
- `yfinance`: documentacao do cliente Python usado para obter dados do Yahoo Finance.
